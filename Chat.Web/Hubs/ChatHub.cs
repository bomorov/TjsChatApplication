...
namespace Chat.Web.Hubs
{
    ...
    public class ChatHub : Hub
    {
        ...
        public async Task SendToRoom(string roomName, string message)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(message.Trim()))
                {
                    ...
                    var messageViewModel = _mapper.Map<Message, MessageDto>(msg);
        ...
        public IEnumerable<MessageDto> GetMessageHistory(string roomName)
        {
            ...
            return _mapper.Map<IEnumerable<Message>, IEnumerable<MessageDto>>(messageHistory);
        }
